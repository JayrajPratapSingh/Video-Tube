        ...
        <Stack direction={['column', "row"]} h={'100vh'} >
            ...
            <VStack w={"full"}>
                ...
                <VStack alignItems={'flex-start'} p="8" width={'full'} overflowY={"auto"}>
                    ...
                    <Text>This is a sample video for demo. this is called description of the video you can write here any thing which you want. this description will describe all about the video.
            ...
            <VStack width={["full", "xl"]} alignItems={'stretch'} p={'8'} spacing={"8"} overflow={'auto'} >

               {
                videosArr.map((item, index)=>(
                    <Button varient={'ghost'} colorScheme='purple' onClick={()=>setVideoSrc(item)}>
